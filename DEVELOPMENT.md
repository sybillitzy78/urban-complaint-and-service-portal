...
```bash
git remote add encore encore://urban-complaint-and-service-portal-vdv2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/urban-complaint-and-service-portal-vdv2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/urban-complaint-and-service-portal-vdv2/settings/integrations/github)
